	...
	<div class="wrapper d-flex align-items-stretch">
        ...
        <?php unset($_SESSION['message_type']); ?>
				...
				<div class="cont-wrapper">
					<h2 class="title-c">Subir Archivo TRD</h2>
					<br><br><br>

					

					<a href="<?=base_url;?>trd_areas/trd_areas.xlsx" class="fas fa-file-excel fa-2x" style="color: #523178;" title="Plantilla"></a><span> Descargar plantilla</span>
					<br><br>
              ...
              <!--  <form class="forms-sample" action="<?=base_url;?>paa/subirArchpaa" name="importa" method="post" enctype="multipart/form-data"> -->
               <form class="forms-sample" action="<?=base_url;?>radica/subirTrd" name="importa" method="post" enctype="multipart/form-data">                
