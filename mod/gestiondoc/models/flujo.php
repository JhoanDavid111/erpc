...
//Metodos CRUD
	public function getAll(){
		$sql = "SELECT f.idflu, f.actflu, f.metflu, f.idpro, p.nompro, f.ordflu, f.areas, f.ntipo, f.color FROM flujo AS f INNER JOIN proceso AS p ON f.idpro=p.idpro";
		// echo $sql;
	...
	public function getProceso(){
		$sql = "SELECT idpro, nompro FROM proceso";
		// echo $sql;
		$execute = $this->db->query($sql);
		$rub = $execute->fetchall(PDO::FETCH_ASSOC);
		// var_dump($rub);
