...
$prepdf = new Prepdf();
$prepdf->setIdprov($idprov);
$dat = $prepdf->getCaliProv();
$datpre = $prepdf->getPreguntasProv();
$dateva = $prepdf->getCaliProvT();
	...
	$html .="<div align='left' style='float: left;'>";
		...
		$html .= "<tr>";
			...
			$html .= "<td rowspan='4' align='center' class='neg'>";
				$html .= "EVALUACIÓN DE PROVEEDORES<br>CONSOLIDADO GENERAL";
			$html .= "</td>";
			$html .= "<td>";
				$html .= "C&oacute;digo: ";
			$html .= "</td>";
...
// Resultados de la tabla FIN ---------------------------------------------
			...
			$html .= "<tr>";
				$html .= "<td colspan='4'>";
					$html .= "<strong>Evaluaron:</strong><br>";
					$html .= "<div class='bifb'>";
						//$html .= "<div class='paiz'><br>Ordenador de Gasto</div>";
						//$html .= "<div class='paiz'>".$dat[0]['pernom']." ".$dat[0]['perape']."<br>Interventor / Supervisor</div>";
					if($dateva){
						foreach ($dateva AS $dtev) {
							$html .= $dtev['fecha']." ".$dtev['pernom']." ".$dtev['perape'];
							//$html .= " <strong> Calificación Final: </strong>".$dtev['califica'];
							$html .= "<br>";
						}
					}
					$html .= "</div>";
