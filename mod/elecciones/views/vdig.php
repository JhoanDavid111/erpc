<h2 class="title-c">Visualizar para Digital &nbsp;&nbsp;&nbsp;&nbsp;</h2>

<?php echo "<h4><br>Mostrando: ".$btn.". ".$nmnc." No. Registros: ".$ctd."</h4>"; ?>
<div class="row" style="margin-top: 10px;">
	<div class="form-group col-md-3" style="text-align: center;">
		<a href="<?=base_url;?>views/gravertical2.php" target="_blank">
			<button type="button" class="btn-secondary-ccapital btnvisu" style="background-color: #00f;">1127x2008<br>TIK TOK</button>
		</a>
	</div>
	<div class="form-group col-md-3" style="text-align: center;">
		<a href="<?=base_url;?>views/grahorizontal2.php" target="_blank">
			<button type="button" class="btn-secondary-ccapital btnvisu" style="background-color: #00f;">1200x630<br>X</button>
		</a>
	</div>
	<div class="form-group col-md-3" style="text-align: center;">
		<a href="<?=base_url;?>views/gracuadrado.php" target="_blank">
			<button type="button" class="btn-secondary-ccapital btnvisu" style="background-color: #0f0;">1100x1100<br>INSTAGRAM</button>
		</a>
	</div>
	...
	<?php if($dm){ foreach ($dm as $dtdm) { ?>		
		...
		<div class="form-group col-md-2" style="text-align: left;padding: 2px !important;margin: 0px !important;">
			<?php $cfg = NULL;
				...
				$cfg = $mbas->getCfg(5);
			?>
			<form action="<?=base_url;?>xml/digital" method="POST">
				<div class="row">
					...
					<div class="form-group col-md-6" style="text-align: left;padding: 2px !important;margin: 0px !important;">
						<button type="submit" class="btn-secondary-ccapital" title="TikTok" <?=$styl;?>><i class="fa fa-mobile" aria-hidden="true"></i></button>
					</div>
				</div>
			</form>
			<?php //} ?>
		</div>
		<div class="form-group col-md-3" style="text-align: left;padding: 2px !important;margin: 0px !important;">
			<?php //if($dtdm['pcv']==1){
			...
			<form action="<?=base_url;?>xml/digital" method="POST">
				<div class="row">
					...
					<div class="form-group col-md-6" style="text-align: left;padding: 2px !important;margin: 0px !important;">
						<button type="submit" class="btn-secondary-ccapital" title="Pantalla X" <?=$styl;?>><i class="fa fa-times" aria-hidden="true"></i></button>
					</div>
				</div>
			</form>
			<?php //} ?>
		...
		<div class="form-group col-md-3" style="text-align: left;padding: 2px !important;margin: 0px !important;">
			...
			<form action="<?=base_url;?>xml/digital" method="POST">
				<div class="row">
					...
					<div class="form-group col-md-6" style="text-align: left;padding: 2px !important;margin: 0px !important;">
						<button type="submit" class="btn-secondary-ccapital" title="Instagram" <?=$styl;?>><i class="fa fa-camera" aria-hidden="true"></i></button>
					</div>
				</div>
			</form>
			<?php //} ?>
