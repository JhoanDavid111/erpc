...
<head>
    ...
    <style type="text/css">
        ...
        body {
            ...
            background-image: url(../img/fondohorizontal2.png);
...
<div class="bar-chart-container">
        ...
        ?>
            <div class="bar" style="height: <?=($percentage * 6.5);?>px;">
...
<script>
    ...
    const marginTop = 220 - maxHeight ; // Ajusta el valor 20 según tus necesidades
