...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,500;1,400;1,800;1,900&display=swap" rel="stylesheet">
    ...
    body {
      font-family: 'Montserrat', sans-serif; /* Nombre de la fuente */
      font-weight: 400; /* Peso de la fuente (normal) */
    }

    /* Añade este código si deseas que el body cubra todo el viewport */
    html, body {
      height: 100%;
    }

    .image-container {
      background-image: url(../img/fondovertical2.png);
      background-size: 1127px 2008px; /* Establece las dimensiones originales */
      background-repeat: no-repeat;
      background-position: center top; /* Centra horizontalmente y coloca la imagen en la parte superior */
      height: 2008px; /* Establece la altura igual a la de la imagen */
      overflow: auto; /* Habilita la barra de desplazamiento vertical */
    }
  ...
  /*  background-color: #ff9801;*/
    ...
    background-position: center; /* Centra horizontalmente la imagen de fondo */
    color: #fff;
    font-size: 25px;
    font-weight: bold;
    margin: 0px auto;
  ...
  .bar-chart {  
    ...
    .y-axis-line {
      ...
      height: 180px; /* Altura de la línea (250px en este caso) */
  ...
  <div class='barra'> 
    <div class="barint" >
      <div  style="text-align: center;"> 
        <span class="titu"><?=$ncor;?> DE <?php if($dat) echo $dat[0]['muni']; ?></span>
        <br>      
      </div>
      <div style="text-align: center;">
        ...
        <div class="bar-container">
          ...
          <div class="bar-content">
            <div class="percentage"><?=$percentage;?>%
                <!-- <br><span class="votos"><?= number_format($votes, 0, ',', '.') ?></span> -->
            </div>
            <div class="votos"><?= number_format($votes, 0, ',', '.') ?> </div>
          </div>
        </div>
    <?php }} ?>   
    </div>
...
<!-- Añade esto al final de tu página HTML justo antes de cerrar el cuerpo </body> -->
