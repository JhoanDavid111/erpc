...
<head>
    ...
    <style type="text/css">
        ...
        .barra {
            ...
            background-size: 100% 100%; /* Establece el ancho al 90% y la altura automática */
        ...
        .barint {
            ...
            padding: 10px; /* Ajusta el relleno para que el contenido no toque los bordes */
        }
        ...
        /* Ajustes para pantallas más pequeñas (ajusta según sea necesario) */
...
<div class='barra'>
    <div class="barint">
        <div style="text-align: center;">
            <div class="titu"><?=$ncor;?> DE <?php if($dat) echo $dat[0]['muni']; ?></div>
        </div>
...
<div class="bar-chart-container">
    <?php if($dat){ foreach ($dat as $candidate){ 
      ...
      ?>
            <div class="bar" style="height: <?=($percentage * 12);?>px;">
...
<script>
    ...
    const marginTop = 330 - maxHeight ; // Ajusta el valor 20 según tus necesidades
    const barChartContainer = document.querySelector('.bar-chart-container');
    barChartContainer.style.marginTop = marginTop + 'px';  
