...
// Calcular valor mes final
    ...
    for (var i = 0; i <= ttyear; i++) { 
        ...
        for (var k = mesini; k <= mf; k++) {
            tr.innerHTML += "<th>"+nommeses[k]+" "+tyear+"</th>"; // Interpreta el HTML
        }
        mesini=1;
        tyear++;
    ...
    if (dur==0) {
        ...
        for (var i = 0; i <= ttyear; i++) { 
            ...
            for (var k = mesini; k <= mf; k++) {
                trb.innerHTML += "<td>"+mensualidad+"</td>"; // Interpreta el HTML
            }
            mesini=1;
            tyear++;
        ...
        for (var i = 0; i <= ttyear; i++) { 
            ...
            for (var k = mesini; k <= mf; k++) {
                if(cont==0 && contando==0){
                    trb.innerHTML += "<td>"+document.getElementById('primerm').value+"</td>"; // Interpreta el HTML
                    cont++;              
                    
                }else if(k==mf && contando==months){
                    trb.innerHTML += "<td>"+document.getElementById('ultimom').value+"</td>";
                }else{
                    trb.innerHTML += "<td>"+document.getElementById('ultimom').value+"</td>"; // Interpreta el HTML
    ...
    if (dur>1) {
        ...
        for (var i = 0; i <= ttyear; i++) { 
            ...
            for (var k = mesini; k <= mf; k++) {
                if(cont==0 && contando==0){
                    trb.innerHTML += "<td>"+primerm+"</td>"; // Interpreta el HTML
                    cont++;              
                    
                }else if(k==mf && contando==months){
                    trb.innerHTML += "<td>"+document.getElementById('valormensual').value+"</td>";
                }else{
                    trb.innerHTML += "<td>"+ultimomes+"</td>"; // Interpreta el HTML
    ...
    for (var i = 0; i <= ttyear; i++) { 
        ...
        for (var k = mesini; k <= mf; k++) {
            trf.innerHTML += "<th>"+nommeses[k]+" "+tyear+"</th>"; // Interpreta el HTML
        }
        mesini=1;
        tyear++;
...
// Calcular valor mes final
    ...
    if (meses.value==2 || meses.value==1) { 
        ...
        for (var i = 0; i <= ttyear; i++) { 
            ...
            for (var k = mesini; k <= mf; k++) {
                if(cont==0 && contando==0){
                    trb.innerHTML += "<td>"+ mm +"</td>"; // Interpreta el HTML
                    cont++;              
                    
                }else if(k==mf && contando==months){
                    trb.innerHTML += "<td>"+df+"</td>";
                }else{
                    trb.innerHTML += "<td>"+mensualidad+"</td>"; // Interpreta el HTML
    ...
    if (meses.value>2) {
        ...
        for (var i = 0; i <= ttyear; i++) { 
            ...
            for (var k = mesini; k <= mf; k++) {
                if(cont==0 && contando==0){
                    trb.innerHTML += "<td>"+dmses*diaspm+"</td>"; // Interpreta el HTML
                    cont++;              
