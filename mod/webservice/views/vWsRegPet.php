...
<form class="m-tb-40" action="<?=base_url?>radica/savePeticion" method="POST" enctype="multipart/form-data">
	...
	<script>
		    ...
		    function actualizarDireccion() {
		        ...
		        var letra_uno = $("#letra_uno").val();
		        var bis = $("#bis").val();
		        var letra_dos = $("#letra_dos").val();
		        var sur_norte = $("#sur_norte").val();
		        var numero = $("#numero").val();
		        var letra_tres = $("#letra_tres").val();
		        //var este_oeste = $("#este_oeste").val();

		        var direccion_generada = tipo_via + " " + numeracion + " " + letra_uno + " " + bis + " " + letra_dos + " " + sur_norte + " No." + numero + " " + letra_tres;

		        $("#direccion_generada").val(direccion_generada);
		    }
    ...
    <div class="row">
    	...
    	<div class="form-group col-md-3">
		    ...
		    <select id="tipo_via" name="tipo_via" class="form-control form-control-sm" style="padding: 0px;" onchange="actualizarDireccion()">
    	...
    	<div class="form-group col-md-3">
    		<label for="numeracion">(84*)</label>
    		<input type="number" class="form-control" id="numeracion" name="numeracion" onchange="actualizarDireccion()" required>
    	</div>

    	<div class="form-group col-md-3">
    		<label for="letra_uno">B:</label>
    		<input type="text" id="letra_uno" name="letra_uno" class="form-control" pattern="[A-Za-z]" title="Ingrese una letra de la A-Z" onchange="actualizarDireccion()">
    	</div>

    	<div class="form-group col-md-3">
		    <label for="bis">Bis:</label>
		    <select id="bis" name="bis" class="form-control form-control-sm" style="padding: 0px;" onchange="actualizarDireccion()">
    ...
    <div class="row">
    	...
    	<div class="form-group col-md-3">
	    	<label for="letra_dos">A:</label>
	    	<input type="text" id="letra_dos" name="letra_dos" class="form-control" pattern="[A-Za-z]" title="Ingrese una letra de la A-Z" onchange="actualizarDireccion()">  
    	</div>  	

    	<div class="form-group col-md-3">
		   <label for="sur_norte">Sur/Norte:</label>
		    <select id="sur_norte" class="form-control form-control-sm" name="sur_norte" style="padding: 0px;" onchange="actualizarDireccion()">
		    	<option value="">Ninguno</option>
    	...
    	<div class="form-group col-md-3">
	    	<label for="no">No. (8*)</label>
    		<input type="number" id="numero" name="numero" class="form-control" onchange="actualizarDireccion()">
    	</div>  

    	<div class="form-group col-md-3">
	    	<label for="letra_tres">C</label>
	   		<input type="text" id="letra_tres" name="letra_tres" class="form-control" pattern="[A-Za-z]" title="Ingrese una letra de la A-Z" onchange="actualizarDireccion()">
   		</div>     				
    </div>    
    ...
    <div class="row">
    	<div class="form-group col-md-12">
	    	<label for="direccion_generada">Dirección Generada:</label>
   			<input type="text" id="direccion_generada" name="direccion_generada" class="form-control" readonly>
   		</div>  
    </div>    
