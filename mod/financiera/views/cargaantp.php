	...
	<div class="wrapper d-flex align-items-stretch">
        ...
        <?php unset($_SESSION['message_type']); ?>
				...
				<div class="cont-wrapper">
					<h2 class="title-c">Subir Archivo Plano Anteproyecto</h2>
					<br><br><br>
              ...
              <!--  <form class="forms-sample" action="<?=base_url;?>paa/subirArchpaa" name="importa" method="post" enctype="multipart/form-data"> -->
               <form class="forms-sample" action="<?=base_url;?>paa/subirPlanoAntp" name="importa" method="post" enctype="multipart/form-data">                
