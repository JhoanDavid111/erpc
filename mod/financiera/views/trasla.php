...
<?php echo Utils::tit("Traslado","fa fa-address-card ico3","rubro/index","350px"); ?>
<div id="inser">
	...
	if(isset($edit) && isset($rub)): ?>
		<h2 class="title-c m-tb-40">Editar Traslado <!-- <?=$rub[0]['nomrub']?> --></h2>
		<?php $url_action = base_url."rubro/save&codrub=".$rub[0]['codrub']; ?>
		
	<?php else: ?>
		<h2 class="title-c m-tb-40">Crear Nuevo Traslado</h2>
...
<h2 class="title-c">Traslados 2024</h2>
<br><br>
	        	...
	        	if(isset($rubros)){
		            ...
		            <tr>
		                ...
		                <td>
		                	...
		                	<small style="font-size: 1px;opacity: 0;">Rubro Interno</small>
