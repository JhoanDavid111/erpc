...
$html .= "<br>";
	...
	$html .= "<tr>";
		$html .= "<td style='text-align: right;'>";
			$html .= "<big><strong>";
				if($dat[0][0]['nexpcdp'])
					$html .= "No. Consecutivo: ".$dat[0][0]['nexpcdp'];
				if($dat[0][0]['nbogdata'])
					$html .= "&nbsp;&nbsp;&nbsp;No. Bogdata: ".$dat[0][0]['nbogdata'];
				$html .= "</strong></big>";
		$html .= "</td>";
	$html .= "</tr>";
	$html .= "</table>";
...
$html .= "<table width='".$anchohoja."px' border='1' cellpadding='3px' cellspacing='0'>";
	$html .= "<tr>";
		$html .= "<td><strong>";
			...
			$ruta = "../../../firma/fir_".$dat[0][0]['resp'].".png";
			if (file_exists($ruta)){
			...
			$html .= strtoupper($dat[0][0]['rspn'])."<br>".$dat[0][0]['cargo'];
...
$html .= "<table width='".$anchohoja."px' border='1' cellpadding='3px' cellspacing='0'>";
	$html .= "<tr>";
		...
		$html .= "<td colspan='2'>";
			...
			foreach ($dat as $d) {
				...
				$html .= " - ".$d[0]['nomrub']." $ ".number_format($d[0]['asidpa'], 0, ',', '.');
				$html .= "<br>";
			}			
	...
	$html .= "<tr>";
		...
		$html .= "<td>";
			$sum_ftefindpa=0;
			foreach ($dat as $d) {
				if ($d[0]['ftefindpa']==652){
					$sum_ftefindpa+=$d[0]['asidpa'];
				}		
			}	
			if ($sum_ftefindpa>0) {
				$html .= " $ ".number_format($sum_ftefindpa, 0, ',', '.');
			}		
		$html .= "</td>";
	$html .= "</tr>";
	$html .= "<tr>";
	...
	$html .= "<tr>";
		$html .= "<td>";
			$html .= "<strong>Resoluciónes FUTIC N°</strong>";
		$html .= "</td>";
		$html .= "<td>";
			foreach ($dat as $d) {
				if($d[0]['ft'] and $d[0]['ftefindpa']==653){
					$html .= $d[0]['resolu'];
				}
			}			
		$html .= "</td>";
	...
	$html .= "<tr>";
		...
		$html .= "<td colspan='2'>";
			...
			if ($sum_ftefindpa>0) {
				$html .= ucfirst(convertir($sum_ftefindpa))." pesos mcte ($ ".number_format($sum_ftefindpa, 0, ',', '.').".oo).";
			}
		$html .= "</td>";
	$html .= "</tr>";
	$html .= "<tr>";
...
$html .= "<table width='".$anchohoja."px' border='0' cellpadding='3px' cellspacing='0'>";
	$html .= "<tr>";
		$html .= "<td style='text-align:center;'>";
			...
			$ruta = "../../../firma/fir_".$dat[0][0]['ordgas'].".png";
			if (file_exists($ruta)){
			...
			$html .= "<br>";
			$html .= "<strong>";
				$html .= strtoupper($dat[0][0]['ordg'])."<br>";
