...
//ordgas, planta, cargo
	...
	public function save(){
		$sql= "INSERT INTO persona(nodocemp, pernom, perape, peremail, perpass, ubiid, perdir, pertel, percel, pefid, depid, envema, actemp, ordgas, planta, cargo) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
