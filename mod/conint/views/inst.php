		                ...
		                <?php if($CouAcc<>0){ ?>
		                	...
		                	?>
		                		...
		                		?>
				                	...
				                	<?php }else{ ?>
				                		<i class="fa fa-check-circle fa-2x" title="Pendiente por aprobar acciones por Planeación" style="color: #f00;"></i>
	                					<br><span class="txtajupl">Pend. Planeación.</span>
				                	<?php } ?>
		                	...
		                	<?php }elseif(!$va['perid']){ ?>
	                			...
	                			<br><span class="txtajupl">Por aprobar</span>
	                		<?php }else{ ?>
	                			<?php if($_SESSION['pefid']==74){ ?>
	                				<a href= "<?=base_url;?>plamej/updDAplmj&nopla=<?=$va['nopla'];?>" onclick="return confirm('¿Está seguro de desaprobar este item? Tenga en cuenta que el proceso se inicia y las acciones se desaprueban para realizar ajustes, luego debe aprobar Planeación, por último el líder debe aprobar para poder iniciar el seguimiento.');">
