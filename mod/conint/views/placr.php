<!-- Ver datos -->
<h2 class="title-c">Histórico - Planes Institucionales</h2>
<?php $url_action2 = base_url."plamej/placr"; ?>
		...
		<form class="m-tb-40" action="<?=$url_action2?>" method="POST">
			<div class="row">
				...
				<div class="form-group col-md-3" style="text-align: center;">
					<a href="<?=base_url?>views/pdftot.php?fil1=<?=$fil1;?>&fil2=<?=$fil2;?>&fil3=<?=$fil3;?>&ac=2" target="_blank" title="Imprimir Planes Institucionales">
