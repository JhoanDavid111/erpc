...
<?php echo Utils::tit("pregunta","fas fa-restroom  mr-3","pregunta/index","300px"); ?>
<div id="inser">
	        	...
	        	if(isset($preguntas)){
		            ...
		            <tr>
		                ...
		                <td style="text-align: center;">
		                	<!-- <a href="<?=base_url?>respuesta/edit&iddap=<?=$va['iddap'];?>">
		                		<i class="far fa-eye" style="color: #523178;"></i>
		                	</a> -->
		                	<a href="<?=base_url?>respuesta/index&iddap=<?=$va['iddap'];?>">
			                	<?php if($va['leido']==1){ ?>
